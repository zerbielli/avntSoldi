...
import com.avnt.soldi.config.converter.OffsetDateTimeToStringConverter;
import com.avnt.soldi.config.converter.StringToOffsetDateTimeConverter;
...
@EnableMongoRepositories(basePackages = {"com.avnt.soldi.model.repositories"})
